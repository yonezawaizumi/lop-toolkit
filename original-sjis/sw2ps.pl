...
print "%!PS-Adobe-2.0\n";
print "%%DocumentFonts:Times-Roman Ryumin-Light-RKSJ-H\n";
print "%%Title:LOP map\n";
print "%%Creator:SWA txt2ps filter v1.0\n";
#print "%%Pages: 1\n";
#print "%%PageOrder: Ascend\n";
#print "%%Page: 1\n";
print "%%PageFonts:Times-Roman Ryumin-Light-RKSJ-H\n";
...
#		print "0 setgray\n";
		...
		print "0 0 moveto\n";
		if ($_[0] =~ /^japanese$/i) {
			printf("/Ryumin-Light-RKSJ-H findfont %d scalefont setfont\n",
				   $_[3]);
		} else {
